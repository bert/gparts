...
static void
schgui_cairo_net_draw(SchGUICairoDrawItem *item, cairo_t *cairo);

static void
schgui_cairo_net_mirror_y(SchGUICairoDrawItem *item);

static void
schgui_cairo_net_rotate(SchGUICairoDrawItem *item, double dt);

static void
schgui_cairo_net_translate(SchGUICairoDrawItem *item, double dx, double dy);
...
schgui_cairo_net_class_init(gpointer g_class, gpointer g_class_data)
{
    ...
    klasse->bounds    = schgui_cairo_net_bounds;
    klasse->draw      = schgui_cairo_net_draw;
    klasse->mirror_y  = schgui_cairo_net_mirror_y;
    klasse->rotate    = schgui_cairo_net_rotate;
    klasse->translate = schgui_cairo_net_translate;
}
