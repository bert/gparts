...
#define GPVIEW_TYPE_DEVICE_CTRL (gpview_device_ctrl_get_type())
#define GPVIEW_DEVICE_CTRL(obj) (G_TYPE_CHECK_INSTANCE_CAST((obj),GPVIEW_TYPE_DEVICE_CTRL,GPViewDeviceCtrl))
#define GPVIEW_DEVICE_CTRL_CLASS(cls) (G_TYPE_CHECK_CLASS_CAST((cls),GPVIEW_TYPE_DEVICE_CTRL,GPViewDeviceCtrlClass))
#define GPVIEW_IS_DEVICE_CTRL(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj),GPVIEW_TYPE_DEVICE_CTRL))
#define GPVIEW_IS_DEVICE_CTRL_CLASS(cls) (G_TYPE_CHECK_CLASS_TYPE((cls),GPVIEW_TYPE_DEVICE_CTRL))
#define GPVIEW_DEVICE_CTRL_GET_CLASS(obj) (G_TYPE_INSTANCE_GET_CLASS((obj),GPVIEW_TYPE_DEVICE_CTRL,GPViewDeviceCtrlClass))

/*! \extends GObject */
struct _GPViewDeviceCtrl
{
    GObject parent;
};

/*! \private */
struct _GPViewDeviceCtrlClass
{
    GObjectClass parent;
};
...
/*! \brief Create a new device view controller
 *
 ...
 */
void
gpview_device_ctrl_set_ui_manager(GPViewDeviceCtrl *view, GtkUIManager *ui_manager);
