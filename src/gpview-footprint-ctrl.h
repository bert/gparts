...
/*! \file gpview-footrpint-view.h
 */

#define GPVIEW_TYPE_FOOTPRINT_CTRL (gpview_footprint_ctrl_get_type())
#define GPVIEW_FOOTPRINT_CTRL(obj) (G_TYPE_CHECK_INSTANCE_CAST((obj),GPVIEW_TYPE_FOOTPRINT_CTRL,GPViewFootprintCtrl))
#define GPVIEW_FOOTPRINT_CTRL_CLASS(cls) (G_TYPE_CHECK_CLASS_CAST((cls),GPVIEW_TYPE_FOOTPRINT_CTRL,GPViewFootprintCtrlClass))
#define GPVIEW_IS_FOOTPRINT_CTRL(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj),GPVIEW_TYPE_FOOTPRINT_CTRL))
#define GPVIEW_IS_FOOTPRINT_CTRL_CLASS(cls) (G_TYPE_CHECK_CLASS_TYPE((cls),GPVIEW_TYPE_FOOTPRINT_CTRL))
#define GPVIEW_FOOTPRINT_CTRL_GET_CLASS(obj) (G_TYPE_INSTANCE_GET_CLASS((obj),GPVIEW_TYPE_FOOTPRINT_CTRL,GPViewFootprintCtrlClass))

/*! \extends GObject */
struct _GPViewFootprintCtrl
{
    GObject parent;
};

/*! \private */
struct _GPViewFootprintCtrlClass
{
    GObjectClass parent;
};
...
/*! \brief Create a new footprint view controller
 *
 ...
 */
void
gpview_footprint_ctrl_set_ui_manager(GPViewFootprintCtrl *view, GtkUIManager *ui_manager);
