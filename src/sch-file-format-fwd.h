...
/*! \file sch-file-format-fwd.h
 *
 *  Foward definitions for file formats. These are currently file format 2, until
 *  class heirarchy gets created for all the file formats.
 */
...
typedef struct _SchFileFormat2 SchFileFormat2;
typedef struct _SchFileFormat2Class SchFileFormat2Class;
